...
📚 {bot.me.mention} adalah bot multi client yang dapat membuat userbot dengan sangat mudah.</b>

<b>✨ bot ini di kembangkan oleh: @IPANNEWERA, bot ini di rancang untuk memudahkan pengguna telegram untuk mengirim pesan group&user telegram dengan instant, dan memiliki banyak fitur yang berguna lainnya.
