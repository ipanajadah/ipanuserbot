...
async def _(client, message): 
    ...
    return await message.reply_photo(msg, reply_markup=InlineKeyboardMarkup(buttons))
...
ɪᴅ : {new_client.me.id}
ᴘʀᴇꜰɪxᴇꜱ : {' '.join(SH)} 
ʜᴀʀᴀᴘ ᴊᴏɪɴ : @notfaundlogs ʜᴀʀᴀᴘ ᴊᴏɪɴ ʀᴏᴏᴍ ᴅɪᴀᴛᴀs ᴅᴀɴ ᴊᴀɴɢᴀɴ ᴏᴜᴛ ᴀɢᴀʀ sᴀғᴇᴛʏ
